...
const SchoolsPage = () => {
  return (
    <>
      <Container
        className="mt-[80px] py-[80px] pb-[120px] bg-dark-grey relative flex flex-col gap-[60px] text-center sm:text-left"
        id="schools"
      >
        ...
        <div className="md:text-[20px] lg:text-[28px] leading-loose tracking-wide w-full lg:w-2/3">
          ...
          <p>
            <span className="text-silver">Shining a light on</span> the decline
